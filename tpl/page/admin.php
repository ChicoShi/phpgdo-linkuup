...
<section class="lup-admin-hub">
	...
	<nav class="lup-admin-actions" aria-label="LinkUUp Verwaltung">
		...
		<a class="lup-admin-action" href="<?=href('LinkUUp', 'LocationMap')?>"><i class="fas fa-draw-polygon"></i><span><strong>Location-Karte</strong><small>Flächen und Geofences bearbeiten</small></span><b><i class="fas fa-arrow-right"></i></b></a>
