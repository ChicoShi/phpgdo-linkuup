...
Aktueller Stand 12.09.2026: Die gemeinsame Backend-Gestaltung ist in `css/lup-backend-views.css` gebündelt und über das LinkUUp-Modul eingebunden. Sie vereinheitlicht den gesamten Inhaltsbereich aller 13 geprüften Ansichten: Typografie, Abstände, Karten, Formulare, Akkordeons, Tabellen, Pagination, Aktionen und Footer. Die Gestaltung ist auf Desktop und schmalen Ansichten responsiv; die Landingpage bleibt über den Scope `body.lup-backend:not(.lup-arrival-active)` unangetastet. Die neuen Regeln wurden auf allen 13 Routen jeweils am oberen und unteren Seitenende visuell geprüft. Keine Formulare wurden abgesendet.
